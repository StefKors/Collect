...
/// Draw Image of Highlighted PDF
/// - Parameters:
///   - filePath: path to pdf
///   - pageNumber:
///   - lowerBound:
///   - upperBound:
/// - Returns: file url to highlighted image
func drawPDFHighlightImage(filePath: String, pageNumber: Int, lowerBound: Int, upperBound: Int) -> URL {
    ...
    do {
        let imagePath = try createHighlightedImage(from: pdfDocument, pageIndex: pageNumber, range: range)
