...
fileprivate struct FloatingPanelModifier<PanelContent: View>: ViewModifier {
    ...
    // @Binding var collectRect: CGRect = CGRect(x: 0, y: 0, width: 624, height: 512)
...
class FloatingPanel<Content: View>: NSWindow {
    ...
    //     let size = CGSize(width: frameRect.size.width, height: frameRect.size.height + frameRect.origin.y)
